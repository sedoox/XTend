...
public class AddEcore2JavaBuilder extends AbstractHandler implements IHandler {  
 
public static String BUILDER_ID=Ecore2JavaBuilder.BUILDER_ID;
 ...
 public Object execute(final ExecutionEvent event) {  
  ...
  if (project != null) {  
   try {  
    ...
    buildCommand.setBuilderName(BUILDER_ID);  
